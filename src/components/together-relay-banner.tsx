    ...
    <div className="flex items-start gap-2.5 rounded-[14px] border border-edge-soft bg-elevated px-3.5 py-3">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-1">
        <span className="text-[12.5px] font-medium text-ink">
          {pub
            ? "Nexa's public relay has not rolled out the latest protocol yet."
        ...
        <span className="text-[11.5px] leading-snug text-ink-muted">
          {pub
            ...
            : "Redeploy it to get the latest Watch Together fixes. Nexa's public relay updates on its own."}
        </span>
        {!pub && (
          <button
            onClick={() => {
