...
export const RECIPES: Recipe[] = [
  ...
  <div style="font:600 26px var(--font-display); color:var(--color-ink);">Nexa</div>
  ...
  console.info('now viewing', e.detail.view);
    ...
    why: "Nexa dispatches lifecycle events on window. Listen from your theme JS.",
  },
];
...
@html
<aside class="rail">
  <div style="font:600 26px var(--font-display); color:var(--color-ink); padding:2px 10px;">Nexa</div>
  <button onclick="window.harbor.navigate('home')">Home</button>
  <button onclick="window.harbor.navigate('movies')">Movies</button>
  <button onclick="window.harbor.navigate('shows')">Shows</button>
