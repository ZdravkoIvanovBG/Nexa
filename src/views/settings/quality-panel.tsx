  ...
  return (
    <>
      ...
      <Section
        ...
        subtitle={t(
          "Nexa finds intro and credits timing from TheIntroDB and the file's own chapters, then shows a Skip button at the right moment.",
        )}
      >
        <ToggleRow
          label={t("Show the Skip button")}
          sub={t(
            "Show a Skip Intro / Skip Credits button when Nexa detects one. Turn this off to never show it. You can also tap the X on the button to dismiss a wrong one for the rest of the episode.",
          )}
