  ...
  return (
    <div className="mt-2 flex flex-col gap-3 border-t border-edge-soft/60 pt-4">
      ...
      <ToggleRow
        ...
        sub={t(
          "Turn the season button into a TVDB-style panel: order tabs (Aired, DVD, Absolute, and any the show has) plus a season table with air-date ranges and episode counts. On by default for anime through Nexa's TVDB service, no key needed. Add your own TVDB key to use it for regular shows too.",
        )}
